  ...
  return (
    <div>
      ...
      <div className="admin-card" style={{ padding: '0' }}>
        <div style={{ padding: '1.5rem', borderBottom: '1px solid rgba(124,58,237,0.1)' }}>
          <input 
            type="text" 
                  ...
                  <tr key={p.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                    ...
                    <td style={{ padding: '1rem' }}>
                      <span style={{ 
                        ...
                        background: p.featured ? 'rgba(124,58,237,0.1)' : 'rgba(255,255,255,0.05)',
                    ...
                    <td style={{ padding: '1rem', textAlign: 'right' }}>
                      <div style={{ display: 'flex', gap: '0.5rem', justifyContent: 'flex-end' }}>
                        <button onClick={() => openEditModal(p)} style={{ background: 'rgba(124,58,237,0.1)', color: 'var(--color-gold)', border: 'none', padding: '0.5rem', borderRadius: '4px', cursor: 'pointer' }}>
                          <Edit2 size={16} />
                        </button>
