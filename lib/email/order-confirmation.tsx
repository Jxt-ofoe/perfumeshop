  ...
  return (
    <div style={{ fontFamily: 'Jost, sans-serif', color: '#0a0805', maxWidth: '600px', margin: '0 auto', border: '1px solid #e0d5c1' }}>
      <div style={{ backgroundColor: '#0a0805', padding: '30px', textAlign: 'center' }}>
        <h1 style={{ fontFamily: '"Cormorant Garamond", serif', color: '#7c3aed', letterSpacing: '0.2em', textTransform: 'uppercase', margin: 0, fontWeight: 400 }}>
          VELOUR
        </h1>
      </div>
      ...
      <div style={{ padding: '40px 30px', backgroundColor: '#fdfbf9' }}>
        ...
        <div style={{ marginTop: '40px', marginBottom: '40px' }}>
          <h3 style={{ fontSize: '12px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#7c3aed', borderBottom: '1px solid #e0d5c1', paddingBottom: '10px' }}>
            Order Details
          </h3>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '20px' }}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style={{ padding: '20px 0 0', fontWeight: 'bold', textAlign: 'right', color: '#7c3aed' }}>{formatPrice(totalAmount)}</td>
              </tr>
            </tbody>
          </table>
        </div>

        <div style={{ backgroundColor: '#f5f0e8', padding: '20px', borderLeft: '3px solid #7c3aed' }}>
